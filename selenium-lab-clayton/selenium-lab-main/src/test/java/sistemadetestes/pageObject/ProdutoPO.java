...
public class ProdutoPO extends LoginPO {
    @FindBy(id = "produto")
    public WebElement inputCadastroProduto;
     ...
     * @param codigo Email para tentativa de login
     * @param descricao Senha para tentativa de login
     * */
    public void executarAcaoDeCadastro(String codigo, String descricao) {
        escrever(inputCodigo, descricao);
        escrever(inputCodigo, descricao);
        buttonEntrar.click();
    }
